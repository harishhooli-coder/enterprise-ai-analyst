"""Direct in-process warehouse execution (shared by direct path and MCP server)."""
...
def execute_warehouse_direct(
    ...
    *,
    ...
    """Execute a vetted, parameterized template in-process."""
